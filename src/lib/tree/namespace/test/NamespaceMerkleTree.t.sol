...
contract NamespaceMerkleTreeTest is DSTest {
    ...
    function testVerifyNone() external {
        ...
        uint256 key = 0;
        uint256 numLeaves = 0;
        NamespaceMerkleProof memory proof = NamespaceMerkleProof(
            sideNodes,
            key,
            numLeaves
        );
    ...
    function testVerifyOneLeafSome() external {
        ...
        NamespaceNode memory root = NamespaceNode(
            nid,
            nid,
            0x56d8381cfe28e8eb21da620145b7b977a74837720da5147b00bfab6f1b4af24d
        );
        NamespaceNode[] memory sideNodes;
        uint256 key = 0;
        uint256 numLeaves = 1;
    ...
    function testVerifyOneLeaf01() external {
        ...
        NamespaceNode memory root = NamespaceNode(
            nid,
            nid,
            0x353857cdb4c745eb9fdebbd8ec44093fabb9f08d437e2298d9e6afa1a409b30c
        );
        NamespaceNode[] memory sideNodes;
        uint256 key = 0;
        uint256 numLeaves = 1;
    ...
    function testVerifyLeafOneOfTwo() external {
        NamespaceNode memory root = NamespaceNode(
            ...
            Namespace(
                0x00,
                0x00000000000000000000000000000000000000000000000000000020
            ),
    ...
    function testVerifyLeafOneOfFour() external {
        NamespaceNode memory root = NamespaceNode(
            ...
            Namespace(
                0x00,
                0x00000000000000000000000000000000000000000000000000000040
            ),
        ...
        sideNodes[1] = NamespaceNode(
            Namespace(
                0x00,
                0x00000000000000000000000000000000000000000000000000000030
            ),
            Namespace(
                0x00,
                0x00000000000000000000000000000000000000000000000000000040
    ...
    function testVerifyLeafNineOfTen() external {
        NamespaceNode memory root = NamespaceNode(
            ...
            Namespace(
                0x00,
                0x00000000000000000000000000000000000000000000000000000060
            ),
    ...
    function testVerifyInternalNodeOneAndTwoOfFour() external pure {
        ...
        bytes memory data = hex"01";
        NamespaceNode memory node1 = leafDigest(
            Namespace(
                0x00,
                0x00000000000000000000000000000000000000000000000000000010
            ),
        ...
        NamespaceNode memory node2 = leafDigest(
            Namespace(
                0x00,
                0x00000000000000000000000000000000000000000000000000000020
            ),
        ...
        NamespaceNode memory node3 = leafDigest(
            Namespace(
                0x00,
                0x00000000000000000000000000000000000000000000000000000030
            ),
        ...
        NamespaceNode memory node4 = leafDigest(
            Namespace(
                0x00,
                0x00000000000000000000000000000000000000000000000000000040
            ),
        ...
        bool isValid = NamespaceMerkleTree.verifyInner(
            root,
            proof,
            startingNode,
            startingHeight
