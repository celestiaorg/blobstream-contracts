...
contract Peggy is Initializable, OwnableUpgradeableWithExpiry, Pausable, ReentrancyGuard {
    ...
    function makeCheckpoint(ValsetArgs memory _valsetArgs, bytes32 _peggyId) private pure returns (bytes32) {
    ...
    function sendToCosmos(
        ...
        state_lastEventNonce = state_lastEventNonce + 1;
        emit SendToCosmosEvent(_tokenContract, msg.sender, _destination, _amount, state_lastEventNonce);
    }
