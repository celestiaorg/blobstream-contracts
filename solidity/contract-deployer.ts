...
import { TestERC20A } from "./typechain";
import { TestERC20B } from "./typechain";
import { TestERC20C } from "./typechain";
...
async function deploy() {
  ...
  if (args["test-mode"] == "True" || args["test-mode"] == "true") {
    ...
    const { abi: abi1, bytecode: bytecode1 } = getContractArtifacts("./artifacts/contracts/TestERC20B.sol/TestERC20B.json");
    ...
    const { abi: abi2, bytecode: bytecode2 } = getContractArtifacts("./artifacts/contracts/TestERC20C.sol/TestERC20C.json");
  ...
  console.log(`Deploying Peggy Contract with peggyId ${peggyId}, vote_power ${vote_power}, eth_addresses ${eth_addresses}, powers ${powers}`)
  console.log(`Note: peggyId ${peggyId} equals bytes32 of ${peggyIdString}`)
