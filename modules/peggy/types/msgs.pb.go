...
type MsgDepositClaim struct {
	...
	TokenDecimals  uint64                                 `protobuf:"varint,9,opt,name=token_decimals,json=tokenDecimals,proto3" json:"token_decimals,omitempty"`
}
...
func (m *MsgDepositClaim) GetTokenName() string {
	if m != nil {
		return m.TokenName
	}
	return ""
...
func (m *MsgDepositClaim) GetTokenSymbol() string {
	if m != nil {
...
func (m *MsgDepositClaim) GetTokenDecimals() uint64 {
	if m != nil {
...
var fileDescriptor_f74c0d0c1d859e2f = []byte{
	...
	,
}
...
func (m *MsgDepositClaim) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TokenSymbol) > 0 {
		...
		i = encodeVarintMsgs(dAtA, i, uint64(len(m.TokenSymbol)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.TokenName) > 0 {
		...
		i = encodeVarintMsgs(dAtA, i, uint64(len(m.TokenName)))
		i--
		dAtA[i] = 0x3a
	}
	...
	for iNdEx < l {
		...
		case 9:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TokenDecimals |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
